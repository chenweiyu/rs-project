<template>
  <div style="margin-top: 40px; margin-bottom:20px">
    ...
    <div class="home" style="margin-left: -200px">
      ...
      <div
        id="echarts1"
        style="width: 600px; height: 400px; margin-left: 650px"
      ></div>
      ...
      <div style="margin-left: 250px">
        ...
        >
          ...
          <el-table-column
            ...
            width="60"
          ></el-table-column>
          <el-table-column prop="sectionNum" label="部门编号">
          </el-table-column>
          <el-table-column prop="section_name" label="部门名称">
          </el-table-column>
          <el-table-column prop="sectionPlace" label="部门位置">
          </el-table-column>
          <el-table-column prop="commitTime" label="创立时间">
          </el-table-column>
      ...
      >
        ...
        >
          <el-form-item label="部门编号" prop="sectionNum">
            <el-input v-model="editForm.sectionNum"></el-input>
          </el-form-item>
          <el-form-item label="部门名称" prop="sectionName">
            <el-input v-model="editForm.section_name"></el-input>
          </el-form-item>
          <el-form-item label="部门位置" prop="sectionPlace">
            <el-input v-model="editForm.sectionPlace"></el-input>
          </el-form-item>
        </el-form>
        <!-- 底部 -->
        <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    async getEcharts() {
      const { data: res } = await this.$http.get("/section/getNumEcharts");
      console.log(res);
      ...
      var arrNew = [];
      option.xAxis.data = res.data.map((item) => {
    ...
    async showEditDialog(staff_id) {
      ...
      const { data: res } = await this.$http.get("/section/info/" + staff_id);
      if (res.code !== 200) {
    ...
    removeById(id) {
      ...
      this.$confirm("此操作将永久删除数据, 是否继续?", "提示", {
        ...
        .then(async () => {
          // 删除逻辑
          const { data: res } = await this.$http.post("/section/delete", [id]);
