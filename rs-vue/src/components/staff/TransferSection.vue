<template>
  <div style="margin-top: 40px">
    <el-breadcrumb separator="/" style="margin-bottom: 40px">
      ...
      <el-breadcrumb-item>员工部门调动</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <div class="home" style="margin-left: -220px">
      ...
      <div style="margin-left: 250px">
        ...
        <el-input
          @keyup.enter.native="getListTransfer"
          placeholder="请输入内容进行搜索..."
          prefix-icon="el-icon-search"
          size="small"
          style="width: 400px; margin-right: 10px"
          v-model="queryInfo1.query"
        >
          <template #append>
            <el-button icon="el-icon-search" @click="getListTransfer"></el-button>
          </template>
        </el-input>
      </div>
        <h4 style="float: left; margin-top: -20px">员工部门调动后列表</h4>
        <div>
          <el-table
            ref="multipleTable"
            :data="listTransfer"
          ...
          >
            ...
            <el-table-column prop="staff_name" label="姓名"> </el-table-column>
            <el-table-column prop="section_name" label="调转前的部门">
            </el-table-column>
            <el-table-column prop="section_after" label="调转后的部门">
            </el-table-column>
        ...
        >
          ...
          >
            ...
            <el-row>
              <el-col :span="10">
                <el-form-item label="当前部门" prop="section_name">
                  <el-input
                    v-model="transferForm.section_name"
                    :disabled="true"
                  ></el-input>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span="10">
                <el-form-item label="开始时间">
                  <el-date-picker
                    v-model="transferForm.beginTime"
                    type="date"
                    format="yyyy-MM-dd"
          ...
          <span slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="saveTransferSection"
              >保 存</el-button
            >
          </span>
        </el-dialog>
...
export default {
  ...
  methods: {
    ...
    async getListTransfer() {
      const { data: res } = await this.$http.post(
        "/transferSection/list",
        this.$qs.stringify(this.queryInfo1)
      );
    ...
    async staffInfo(staff_id) {
      ...
      this.transferForm.section_name = res.data.sectionName;
